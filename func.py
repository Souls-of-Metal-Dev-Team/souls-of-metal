...
def round_corners(surface, radius):
    ...
    pygame.draw.circle(
        rounded_surface, (255, 255, 255), (surface.get_width() - radius, radius), radius
    )
    pygame.draw.circle(
        rounded_surface,
        (255, 255, 255),
        (radius, surface.get_height() - radius),
        radius,
    )
    pygame.draw.circle(
        rounded_surface,
    ...
    pygame.draw.rect(
        rounded_surface,
        (255, 255, 255),
        (radius, 0, surface.get_width() - 2 * radius, surface.get_height()),
    )
    pygame.draw.rect(
        rounded_surface,
        (255, 255, 255),
        (0, radius, surface.get_width(), surface.get_height() - 2 * radius),
    )
